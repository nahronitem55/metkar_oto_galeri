<?php
include 'header.php';//header sayfamızı api-ayarlar ile birleştiriyoruz.
// Bu sayfada api ayarlarını güncelliyoruz.
?>
<!-- page content -->
...
<?php
include 'footer.php'//Boostrap template dosyalarını ekliyoruz;
?>